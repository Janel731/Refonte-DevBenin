...
export const ThemeToggle = ({
    ...
    const getOriginCoordinates = useCallback(buttonRect => {
    ...
    const getAnimationKeyframes = useCallback((x, y, maxRadius, toLight) => {
        switch (animation) {
            case "circle":
                return {
                    clipPath: toLight
    ...
    return (
        <button
            ...
            {...props}>
            <div
                className={cn("transition-all duration-300", isAnimating && "animate-spin")}
                style={{
